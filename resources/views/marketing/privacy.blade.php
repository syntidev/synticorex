...
<head>
    ...
    <title>Politica de Privacidad - SYNTIweb</title>
    <meta name="description" content="Politica de privacidad de SYNTIweb sobre recoleccion, uso y resguardo de datos de cuentas y negocios.">
        ...
        <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
            ...
            <article class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-6 leading-relaxed shadow-sm">
                ...
                <section>
                    ...
                    <p class="mt-2 text-slate-700">Para solicitudes sobre privacidad: <a class="font-semibold text-[#4A80E4] hover:opacity-80" href="mailto:soporte@syntiweb.com">soporte@syntiweb.com</a>.</p>
                </section>
            </article>
        </section>
    </main>

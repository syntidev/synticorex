...
<header class="border-border bg-background py-0.25 fixed top-0 z-10 w-full border-b" data-theme="{{ $themeSlug ?? 'light' }}">
  <nav class="navbar mx-auto max-w-[1280px] rounded-b-xl px-4 sm:px-6 lg:px-8">
    <div class="w-full lg:flex lg:items-center lg:gap-2">
      ...
      <div class="navbar-start items-center justify-between max-lg:w-full">
        <a class="text-foreground flex items-center gap-3 text-xl font-semibold" href="#home">
        ...
        <div class="flex items-center gap-3 lg:hidden">
          ...
          {{-- Hamburger Toggle --}}
          <button type="button" 
                  class="hs-collapse-toggle p-2 rounded-lg border border-border text-foreground/80 hover:bg-surface" 
      ...
      <div id="navbar-collapse" 
        ...
        <div class="text-foreground flex gap-6 text-base max-lg:mt-4 max-lg:flex-col lg:items-center">
          ...
          <div class="flex flex-col gap-4 lg:hidden mt-4 pt-4 border-t border-border">
            ...
            @if($tenant->saved_display_mode === 'both_toggle')
              <button id="currency-toggle-mobile" 
                      class="inline-flex items-center py-1.5 px-3 rounded-lg font-medium transition-colors text-sm border border-border text-foreground/80 hover:bg-surface gap-2 currency-toggle">

...
<section id="contacto" class="bg-surface py-8 sm:py-16 lg:py-24">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid items-center gap-12 lg:grid-cols-2">
      ...
      @else
        <div class="rounded-2xl bg-surface flex items-center justify-center w-full" style="height:300px">
      ...
      <div>
        ...
        <p class="text-foreground/80 mb-10 text-lg font-medium">
        ...
        <div class="grid gap-6 md:grid-cols-2">
          <div class="bg-background border border-border rounded-xl shadow-sm">
            <div class="flex flex-col items-center p-4 gap-3">
              ...
              <h4 class="text-foreground text-base font-medium">Horario</h4>
          ...
          <div class="bg-background border border-border rounded-xl shadow-sm">
            <div class="flex flex-col items-center p-4 gap-3">
              ...
              <h4 class="text-foreground text-base font-medium">Direccion</h4>
              <address class="text-foreground/80 text-center not-italic">
                {{ $address }}<br>
          ...
          <div class="bg-background border border-border rounded-xl shadow-sm">
            <div class="flex flex-col items-center p-4 gap-3">
              ...
              <h4 class="text-foreground text-base font-medium">WhatsApp</h4>
              @if($phoneClean)
              ...
              @else
                <p class="text-foreground/40 text-sm italic">No configurado</p>
              @endif
            </div>
          </div>
          <div class="bg-background border border-border rounded-xl shadow-sm">
            <div class="flex flex-col items-center p-4 gap-3">
              ...
              <h4 class="text-foreground text-base font-medium">Email</h4>
              <div class="text-center text-foreground/80">
                @if($tenant->email)
                  <p>{{ $tenant->email }}</p>
                @endif

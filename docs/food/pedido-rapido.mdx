...
**Configuración:** Se activa automáticamente en el plan Anual de SYNTIfood. No requiere configuración adicional en el dashboard.
...
2× Arepa reina pepiada — $4.00 c/u
1× Tequeños (6 unidades) — $3.50
...
- Categoría "Tortas" (foto de torta de chocolate)
  ...
  - Torta tres leches $18
  - Cheesecake $12
- Categoría "Postres individuales"
  - Brownie $3
  - Quesillo individual $4
...
4. Ve: Torta de chocolate $15 + 2× Brownie $6 = **Total $21**
5. Toca **"Enviar pedido"** → Se abre WhatsApp

Ana recibe: *"1× Torta de chocolate — $15.00, 2× Brownie — $3.00 c/u, Total: $21.00"*

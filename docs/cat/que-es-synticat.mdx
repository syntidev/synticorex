...
- **Carrito de compras** (plan Semestral+): El cliente agrega productos y revisa antes de enviar
...
1. Sube productos: "Camisa polo" ($15, tallas S/M/L/XL, colores negro/blanco/azul)
2. Sube "Jeans clásico" ($25, tallas 28-36), "Gorra deportiva" ($8)
...
- Toca "Enviar pedido" → WhatsApp se abre con:

```
🛍️ Pedido #SC-0047 desde Moda Urbana

1× Camisa polo (M, Azul) — $15.00
1× Jeans clásico (30) — $25.00

Total: $40.00

Código de seguimiento: SC-0047
```

Sofía recibe el pedido con código SC-0047, confirma disponibilidad y coordina pago y envío por WhatsApp.

...
<Note>
  Las variantes básicas (talla y color) están disponibles desde el plan Semestral. Las variantes de extras y opciones personalizadas son exclusivas del plan Anual.
</Note>

## Ver también

- [Catálogo de productos](/cat/catalogo-productos) — Gestión completa de productos
- [Carrito y WhatsApp](/cat/carrito-whatsapp) — Las variantes se incluyen en el mensaje del carrito
- [¿Qué es SYNTIcat?](/cat/que-es-synticat) — Planes y funcionalidades

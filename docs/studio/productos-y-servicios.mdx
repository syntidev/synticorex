...
El proceso es igual que productos. Ve a la pestaña **Qué Vendes** → **+ Nuevo servicio**.
...
Panel → Qué Vendes → toca el toggle junto al producto → queda oculto en tu página.

...
**Configuración** es el último tab del dashboard. Desde aquí controlas los aspectos técnicos de tu negocio: qué métodos de pago aceptas, cómo se muestran los precios, tu PIN de acceso y la información de tu plan actual.

## ¿Dónde lo encuentro?

**Dashboard → Configuración** (último ícono en el menú lateral, ⚙️)

La pantalla se organiza en varias secciones:
...
→ Para más detalles, ve a [Medios de pago](/studio/medios-de-pago)
...
| **Ambos con toggle** (`both_toggle`) | REF/Bs. | **Por defecto.** El cliente puede cambiar entre REF y Bs. |
...
Tu PIN de 4 dígitos es lo que protege el acceso al dashboard. Desde aquí puedes cambiarlo:
...
- No permite cambiar de plan directamente desde el dashboard
...
4. **Tu Plan:** Ve que tiene 12 de 50 productos usados
